...
function Profile() {
    ...
    function handleSubmit1(e) {
       ...
       axios.patch(`http://localhost:3000/api/v1/customer/profile`, obj, {headers : headers}).then((res) => {
        console.log(res);
      }).catch(error => {
        console.log(error)
      })
                    ...
                    <div className={classes['content__information']}>
                        <form className={classes['content__form']}>
                            ...
                            <div className={classes['content__form-text']}>
                                ...
                                <input id="iddate" type="date" className={classes['content__form-input']} placeholder="Nhập ngày sinh"></input>
                            </div>
                            <div className={classes['content__form-text']}>
                                <div className={classes['content__form-start']}>
                            ...
                            {!saveSuccess && <button onClick={handleSubmit1} type="submit" className={classes['save__btn']}>LƯU THAY ĐỔI</button>}
                            {saveSuccess &&  <button onClick={handleSubmit1} type="submit" className={`${classes['save__btn']} ${classes['save__btn--successful']}`}>LƯU THÀNH CÔNG</button>}
                        </form>
                    </div>
